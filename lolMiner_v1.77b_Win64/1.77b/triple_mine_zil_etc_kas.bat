...
:W10
"%MyVariable%" --algo ETCHASH --pool !ZILPOOL! --user !ETHWALLET!.!WORKER! --pass !ZILWALLET!@!ETHPOOL! --enablezilcache --dualmode KASPADUAL --dualpool !KASPOOL! --dualuser !KASWALLET! --watchdog exit !EXTRAPARAMETERS!
if %ERRORLEVEL% == 42 (
	timeout 10
	goto W10
)
...
:OtherW
"%MyVariable%" --algo ETCHASH --pool !ZILPOOL! --user !ETHWALLET!.!WORKER! --pass !ZILWALLET!@!ETHPOOL! --enablezilcache --dualmode KASPADUAL --dualpool !KASPOOL! --dualuser !KASWALLET!  --watchdog exit !EXTRAPARAMETERS! --nocolor
if %ERRORLEVEL% == 42 (
	timeout 10
	goto OtherW
)
